...
TasksTableCompanion _task({
  ...
  return TasksTableCompanion(
    ...
    status: Value(status),
    assignedTo: Value('user1'),
    assignedBy: Value('admin'),
...
ItrFilingsTableCompanion _itrFiling({
  ...
  return ItrFilingsTableCompanion(
    ...
    itrType: Value('ITR-1'),
    assessmentYear: Value('2025-26'),
    financialYear: Value('2024-25'),
...
InvoicesTableCompanion _invoice({
  ...
  return InvoicesTableCompanion(
    ...
    invoiceDate: Value('2026-03-01'),
    dueDate: Value('2026-03-31'),
