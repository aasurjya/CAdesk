...
final filingRecordRemoteSourceProvider = Provider<FilingRecordRemoteSource>((
  ref,
) {
  return FilingRecordRemoteSource(Supabase.instance.client);
});

final filingRecordLocalSourceProvider = Provider<FilingRecordLocalSource>((
  ref,
) {
...
final filingRecordRepositoryProvider = Provider<FilingRecordRepository>((ref) {
  ...
  final useReal = flags.asData?.value.isEnabled('filing_real_repo') ?? false;
