...
/// ITR-2 house property step — same as ITR-1 (annual letable value,
/// municipal taxes, interest on housing loan, Section 24 computation).
class Itr2HousePropertyStep extends ConsumerStatefulWidget {
  const Itr2HousePropertyStep({super.key});

  @override
  ConsumerState<Itr2HousePropertyStep> createState() =>
      _Itr2HousePropertyStepState();
}

class _Itr2HousePropertyStepState extends ConsumerState<Itr2HousePropertyStep> {
  ...
  void initState() {
    super.initState();
    final hp = ref.read(itr2FormDataProvider).housePropertyIncome;
  ...
  void _persist() {
    ...
    ref.read(itr2FormDataProvider.notifier).updateHouseProperty(hp);
  }
  ...
  Widget build(BuildContext context) {
    final hp = ref.watch(itr2FormDataProvider).housePropertyIncome;
