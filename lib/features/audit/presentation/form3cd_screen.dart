        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                const _SectionHeader(title: 'Clauses 1-5: Basic Information'),
                ..._clauseRange(ref, form, 1, 5),
                const SizedBox(height: 12),
                const _SectionHeader(title: 'Clauses 6-12: Books & Accounting'),
                ..._clauseRange(ref, form, 6, 12),
                const SizedBox(height: 12),
                const _SectionHeader(title: 'Clauses 13-19: Tax Compliance'),
                ..._clauseRange(ref, form, 13, 19),
                const SizedBox(height: 12),
                const _SectionHeader(
                  title: 'Clauses 20-30: Deductions & Allowances',
                ),
                ..._clauseRange(ref, form, 20, 30),
                const SizedBox(height: 12),
                const _SectionHeader(title: 'Clauses 31-44: Other Reporting'),
