...
class CashFlowService {
  ...
  static CashFlowStatement computeCashFlow({
    ...
    if (deltaTradePayables != 0) {
      operatingItems.add(CashFlowLineItem(
    ...
    final deltaOtherCurrentLiab = current.equity.otherCurrentLiabilities -
    ...
    final operatingTotal =
        operatingItems.fold(0, (sum, item) => sum + item.amountPaise);
    ...
    if (deltaFixedAssets != 0) {
      investingItems.add(CashFlowLineItem(
    ...
    final investingTotal =
        investingItems.fold(0, (sum, item) => sum + item.amountPaise);
    ...
    if (deltaShareCapital != 0) {
      financingItems.add(CashFlowLineItem(
    ...
    final deltaLongTermBorrowings = current.equity.longTermBorrowings -
        previous.equity.longTermBorrowings;
    ...
    final financingTotal =
        financingItems.fold(0, (sum, item) => sum + item.amountPaise);
    ...
    return CashFlowStatement(
      ...
      operatingLineItems: List<CashFlowLineItem>.unmodifiable(finalOperatingItems),
