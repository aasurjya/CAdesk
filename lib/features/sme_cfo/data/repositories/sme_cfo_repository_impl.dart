...
class SmeCfoRepositoryImpl implements SmeCfoRepository {
  ...
  Future<List<CfoDeliverable>> getDeliverables() async {
    ...
    return List<Map<String, dynamic>>.from(
      response,
    ).map(_deliverableFromJson).toList();
  }
  ...
  CfoDeliverable _deliverableFromJson(Map<String, dynamic> j) => CfoDeliverable(
    id: j['id'] as String,
    retainerId: j['retainer_id'] as String,
    clientName: j['client_name'] as String,
    title: j['title'] as String,
    deliverableType: DeliverableType.values.firstWhere(
      (t) => t.name == j['deliverable_type'] as String,
    ),
  ...
  CfoRetainer _retainerFromJson(Map<String, dynamic> j) => CfoRetainer(
    ...
    status: CfoRetainerStatus.values.firstWhere(
      (s) => s.name == j['status'] as String,
    ),
