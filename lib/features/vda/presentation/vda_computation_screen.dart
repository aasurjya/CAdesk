      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const _RuleItem(text: 'Flat 30% tax on gains (no slab benefit)'),
            const _RuleItem(
            ...
            const _RuleItem(text: 'No indexation benefit on cost'),
            const _RuleItem(text: '1% TDS under Sec 194S by buyer'),
            const _RuleItem(
